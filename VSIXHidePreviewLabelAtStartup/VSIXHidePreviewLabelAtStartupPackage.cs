...
using VSIXHidePreviewLabelAtStartup.Helpers;
using Task = System.Threading.Tasks.Task;

namespace VSIXHidePreviewLabelAtStartup
{
    /// <summary>
    ...
    [Guid(VSIXHidePreviewLabelAtStartupPackage.PackageGuidString)]
    [ProvideAutoLoad(VSConstants.UICONTEXT.NoSolution_string, PackageAutoLoadFlags.BackgroundLoad)]
    [ProvideAutoLoad(VSConstants.UICONTEXT.SolutionExists_string, PackageAutoLoadFlags.BackgroundLoad)]
    public sealed class VSIXHidePreviewLabelAtStartupPackage : AsyncPackage
    {
        /// <summary>
        /// VSIXHidePreviewLabelAtStartupPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "12e01d9c-c566-4470-863c-a2c184262807";
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            Button btn = GetInfoBadgeButton();
            while (btn == null)
            {
                await Task.Delay(2000);
                btn = GetInfoBadgeButton();
            }
